                            ...
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-sm-12 col-xs-12">
                                        <div class="form-wrap">
                                            <form method="post" action="<c:url value="/daily_process/process1/director/terminate"/> ">
                                                <div class="form-body">
                                                    <h6 class="txt-dark capitalize-font"><i class="glyphicon glyphicon-user"> </i>申请记录</h6>
                                                    <hr class="light-grey-hr"/>
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label class="control-label mb-10">申请人姓名</label>
                                                                <input type="text" name="applicant_name" class="form-control" value="<%=directorForm.getApplicant_name()%>" readonly/>
                                                            </div>
                                                        </div>
                                                        <!--/span-->
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="applicant_ehr" class="form-control" value="<%=directorForm.getApplicant_ehr()%>" readonly/>
                                                            </div>
                                                        </div>
                                                        <!--/span-->
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" name="recipient_name" class="form-control" value="<%=directorForm.getRecipient_name()%>" readonly/>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <!--/span-->
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="recipient_ehr" class="form-control" value="<%=directorForm.getRecipient_ehr()%>" readonly/>
                                                            </div>
                                                        </div>
                                                        <!--/span-->
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="manual_item" class="form-control" value="<%=directorForm.getManual_item()%>" readonly/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <!-- /Row -->
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-12 ">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="manual_description" class="form-control" value="<%=directorForm.getManual_detail()%>" readonly/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-12 ">
                                                            <div class="form-group">
                                                                ...
                                                                <textarea name="approval_executive_comment" class="form-control" rows="5" readonly><%=directorForm.getApproval_executive_comment()%></textarea>
                                                            </div>
                                                        </div>
